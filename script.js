const translations = {
    en: {
        ...
        "rooms.l1.r1": "Ideal for: Friends or colleagues",
        "rooms.l1.r2": "Ideal for: Solo travelers or couples",
        "rooms.l1.r3": "Ideal for: Small families or groups",
        "rooms.level2.title": "Level 2 (Main House)",
        "rooms.level2.desc": "Elevated comfort and quiet relaxation.",
        "rooms.l2.r1": "Ideal for: Traveling friends",
        "rooms.l2.r2": "Ideal for: Solo guests or couples",
        "rooms.l2.r3": "Ideal for: Families or friends",
        "rooms.l2.r4": "Ideal for: Families with a child",
        "rooms.house.title": "Main House Suite",
        "rooms.house.desc": "A fully-equipped house booking option.",
        "rooms.house.beds": "3 Queen Beds",
        "rooms.house.feats": "Kitchen, 2 Baths, Washing Machine, Refrigerator",
        "rooms.house.ideal": "Ideal for: Larger families or group getaways",
        ...
        "rooms.sep.s1": "Ideal for: Longer stays and independent travelers",
        "rooms.sep.s2": "Ideal for: Couples or solo guests looking for a quiet retreat",
    ...
    kr: {
        ...
        "rooms.l1.r1": "추천: 친구, 직장 동료",
        "rooms.l1.r2": "추천: 1인 여행객, 커플",
        "rooms.l1.r3": "추천: 소규모 가족, 그룹",
        "rooms.level2.title": "2층 본채 (Level 2)",
        "rooms.level2.desc": "한층 더 아늑하고 조용한 휴식이 가능합니다.",
        "rooms.l2.r1": "추천: 친구, 여행객",
        "rooms.l2.r2": "추천: 1인 여행객, 커플",
        "rooms.l2.r3": "추천: 가족, 친구 모임",
        "rooms.l2.r4": "추천: 아이를 동반한 가족",
        "rooms.house.title": "본채 전체 대관 (Suite)",
        ...
        "rooms.sep.s1": "추천: 장기 숙박객, 독립적인 여행객",
        "rooms.sep.s2": "추천: 커플, 나만의 조용한 휴식을 원하는 여행객",
